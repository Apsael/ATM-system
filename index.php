...
{
    $availableBills = [200, 100, 50, 20, 10];
    $result = [];
    ...
    if (!in_array($amount, $presetValues) && ($amount < 10 || $amount > 1000 || $amount % 10 != 0)) {
        return false;
    }
    ...
    <div class="atm-container">
        <div class="atm-frame">
            ...
            <div class="atm-footer">
                <div class="footer-message">Banco Cruceño ATM by Diego Fernández ©</div>
            </div>
        </div>
    </div>
